<div id="footer">
    ...
    <div class=container>
        <div class="row " >
            <!-- Desktop -->
            <div class="col-xs-12 col-lg-6 offset-lg-5 d-none d-sm-flex flex-row flex-wrap justify-content-between mt-1 pt-1" style= 'border-top: #16a085 2px solid;'>
            ...
            <div>
            <!-- Mobile -->
            <div class="d-sm-none col-12 justify-content-between mt-1 pt-1" style= 'border-top: #16a085 2px solid;'>
