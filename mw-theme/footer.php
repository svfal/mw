<div id="footer">
    ...
    <div class=container>
        <div class="row " >
            <div class="col-xs-12 col-lg-6 offset-lg-5 d-flex " style= 'margin-top:1em; border-top: #16a085 2px solid;'>
                <div class="d-sm-flex flex-row col-6 justify-content-between ">
